    ...
    public static void main(String[] args) throws Exception {
        ...
        while ((str = in.readLine()) != null) {
            ...
            if(StringUtils.isNotBlank(stream)){
                if (stream.indexOf("yuntingbcast")>0) {
        ...
        System.out.println("1,2,1600000000079,4,"+Stream2Sign.addSign("http://yuntingbcast.radio.cn/80/radios/10300/index_10300.m3u8?type=1"));
        //System.out.println("1600000000079");
